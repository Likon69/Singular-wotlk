...
namespace Singular.ClassSpecific.Paladin
{
    public static class Holy
    {
        ...
        public static Composite CreateHolyPaladinCombatBehavior()
        {
            return
                new PrioritySelector(
                    Spell.Buff("Judgement of Light",
                               ret => SpellManager.HasSpell("Judgement of Light") && StyxWoW.Me.GotTarget &&
                                       StyxWoW.Me.CurrentTarget.Distance <= SpellManager.Spells["Judgement of Light"].MaxRange - 2 &&
                    ...
                    new Decorator(
                        ...
                        new PrioritySelector(
                            ...
                            // WotLK: Crusader Strike is Ret talent only (became baseline in Cata 4.0.1), removed
                            Spell.Cast("Exorcism"),
