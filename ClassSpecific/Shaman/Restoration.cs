    ...
    class Restoration
    {
        ...
        public static Composite CreateRestoShamanHealingBuffs()
        {
            return new PrioritySelector(
                ...
                new Decorator(
                    ret => !StyxWoW.Me.Inventory.Equipped.MainHand.TemporaryEnchantment.Name.StartsWith("Earthliving") && StyxWoW.Me.Inventory.Equipped.MainHand.ItemInfo.WeaponClass != WoWItemWeaponClass.FishingPole, // WotLK: check by name prefix to match all ranks
