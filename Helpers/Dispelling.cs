    ...
    internal static class Dispelling
    {
        ...
        public static bool CanDispelMagic
        {
            get
            {
                switch (StyxWoW.Me.Class)
                {
                        // WotLK: Paladin can dispel magic baseline via Cleanse (no talent required)
                        // WotLK: Druid cannot dispel magic (Nature's Cure is Cata 4.0.1)
                        // WotLK: Shaman cannot dispel magic (Improved Cleanse Spirit is Cata 4.0.1)
                    case WoWClass.Druid:
                        return false; // WotLK: Druids only have Remove Curse and Abolish Poison
                    case WoWClass.Paladin:
                        return true; // WotLK: Cleanse removes Magic, Disease, and Poison baseline
                    case WoWClass.Shaman:
                        return false; // WotLK: Cleanse Spirit only removes Curses
