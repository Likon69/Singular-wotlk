...
namespace Singular.Settings
{
    internal class PriestSettings : Styx.Helpers.Settings
    {
        ...
        [Description("Use PW:Shield on self when HP drops below this value")]
        public double ShieldHealthPercent { get; set; }

        // WotLK QC: MindBlastTimer removed — Cata-only "Mind Spike rotation" timer, never referenced in WotLK Shadow.cs
        // [Setting]
        // [DefaultValue(15)]
        // [Category("Shadow")]
        // [DisplayName("Mind Blast Timer")]
        // [Description("Casts mind blast on cooldown after this many seconds")]
        // public int MindBlastTimer { get; set; }

        // WotLK QC: MindBlastOrbs removed — Shadow Orbs do not exist in WotLK (added in Cata 4.0.1)
        // [Setting]
        // [DefaultValue(2)]
        // [Category("Shadow")]
        // [DisplayName("Mind Blast Orbs")]
        // [Description("Casts mind blast on cooldown")]
        ...
        [Description("Use Inner Fire buff")]
